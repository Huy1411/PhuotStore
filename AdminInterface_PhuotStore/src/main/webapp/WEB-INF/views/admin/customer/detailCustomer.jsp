                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <h3 class="profile-username text-center">${detailUser.username}</h3>
                            <p class="text-muted text-center">
                                <c:forEach items="${detailUser.roles}" var="role" varStatus="itr">

                                    <c:if test="${role.roleName =='ROLE_ADMIN'}">
                                        <span class="badge badge-success">ADMIN</span>
                                    </c:if>
                                    <c:if test="${role.roleName =='ROLE_MANAGER'}">
                                        <span class="badge badge-danger">MANAGER</span>
                                    </c:if><c:if test="${role.roleName =='ROLE_EMPLOYEE'}">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <a href="${pageContext.request.contextPath}/admin/user/editUser?id=${detailUser.userID}"
                                       class="btn btn-info btn-block"><i class="fas fa-pencil-alt"></i> Update</a>
                                </div>
                                <div class="col-sm-6">
                                    <a href="${pageContext.request.contextPath}/admin/user/deleteUser?id=${detailUser.userID}"
                                       class="btn btn-secondary btn-block"><i class="fas fa-trash"></i> Delete</a>
                                </div>
                                <!-- /.col -->
                            </div>
