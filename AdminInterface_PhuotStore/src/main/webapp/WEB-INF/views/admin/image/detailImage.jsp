                                        ...
                                        <div class="post">
                                            <div class="user-block">
                                                <table class="table">
                                                    <tr>
                                                        <td>ID</td>
                                                        <td>${detailImage.imgID}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Image Name</td>
                                                        <td>${detailImage.imgName}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Image URL</td>
                                                        <td>${detailImage.imgURL}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Status:</td>
                                                        <td><c:if test="${detailImage.status ==1}">
                                                            ...
                                                            <c:if test="${detailImage.status !=1}">
                                                    ...
                                                    <tr>
                                                        <td>Product</td>
                                                        <td>${detailImage.product.productName}</td>
                                                    </tr>
                                                </table>
                                                <a href="${pageContext.request.contextPath}/admin/image/editImage?id=${detailImage.productID}"
