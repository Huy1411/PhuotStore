                ...
                <div class="col-md-12">
                    <div class="card card-warning collapsed-card">
                        <div class="card-header">
                            <h3 class="card-title">Look Up Combo</h3>
                        ...
                        <table class="table table-striped projects">
                            ...
                            <c:forEach items="${combos}" var="combo" varStatus="itr">
                                <tr>
                                    ...
                                    <td>
                                        <c:if test="${combo.status ==1}">
                                            <span class="text-bold"> </span>
                                            <span class="badge badge-success">Show</span>
                                        </c:if>
                                        <c:if test="${combo.status ==2}">
                                            <span class="text-bold"> </span>
                                    ...
                                    <td class="project-actions ">
                                        ...
                                        <a href="${pageContext.request.contextPath}/admin/combo/deleteCombo?id=${combo.comboID}"
