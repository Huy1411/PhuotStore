...
<f:form action="${pageContext.request.contextPath}/admin/product/updateImage" method="POST"
        ...
        <div class="row">
            <div class="col-md-10">
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <f:input path="imgID" type="hidden"/>
                        <div class="col-md-12">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="exampleInputEmail1">Image Name</label>
                                    <f:input path="imgName" type="text"
                                             class="form-control ${param.errorimagename !=null ?'border border-danger':''}"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <f:input path="imgURL" type="text"
                                             class="form-control ${param.errorimageURL !=null ?'border border-danger':''}"
